...
save(plotsdir("v2/hysteresis/fig10-reduced.png"), fig10)
save(plotsdir("v2/hysteresis/fig10-reduced.pdf"), fig10)
...
ssp5_2100 = 4.4
ssp5_2300 = 8.0
vlines!(ax2, ssp5_2100, label = "mean SSP5-8.5, 2100", color = :red, linestyle = :dash; ssp_line_opts...)
vlines!(ax2, ssp5_2300, label = "mean SSP5-8.5, 2300", color = :darkred, linestyle = :dash; ssp_line_opts...)
...
axislegend(ax2, position = :rt, nbanks = 1)
...
iii = sortperm(ii)
xps = xps[iii]
push!(xps, datadir("output/ais/v2/hyster/retreat/aqef/refnomslow"))
...
xlims!(ax4, 0, 11)
fig12
save(plotsdir("v2/hysteresis/fig12-reduced.png"), fig12)
save(plotsdir("v2/hysteresis/fig12-reduced.pdf"), fig12)