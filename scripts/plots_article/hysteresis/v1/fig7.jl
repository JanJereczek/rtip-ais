...
xps = [
    ...
    datadir("output/ais/hyster/16km/retreat/aqef/pmpt-dpr"),
    datadir("output/ais/hyster/16km/regrowth/aqef/pmpt-$visc_type-dpr"),
...
fig
save(plotsdir("16km/hysteresis/fig7.png"), fig)
save(plotsdir("16km/hysteresis/fig7.pdf"), fig)