...
pd_err_uxy_s = ncread(fn, "pd_err_uxy_s", start = [1, 1, 1], count = [-1, -1, 1])
uxy_s_now = ncread(fn, "uxy_s", start = [1, 1, 20], count = [-1, -1, 1])
...
save(plotsdir("error_plot_u.pdf"), fig)
save(plotsdir("error_plot_u.png"), fig)