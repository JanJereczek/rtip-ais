...
lss = [occursin("fast", xp) ? :dash : :solid for xp in xp_labels]
lal = [occursin("fast", xp) ? 0.3 : 1 for xp in xp_labels]
cycling_colors = [
    xpcolors["ATM"],
    xpcolors["OCN"],
    xpcolors["HOW"],
...
ylims!(ax1, 0, 60)
fig
save(plotsdir("v2/hysteresis/compare-hyst-minvisc.png"), fig)
